...
class LLFirSessionProviderStorage(val project: Project) {
    ...
    fun getSessionProvider(
        ...
        when (useSiteKtModule) {
            ...
            is KtNotUnderContentRootModule -> {
                ...
                LLFirSessionProvider(project, session, KtModuleToSessionMappingByImmutableMapImpl(mapOf(useSiteKtModule to session)))
            }
    ...
    private fun createSessionProviderForSourceSession(
        ...
        return LLFirSessionProvider(project, session, KtModuleToSessionMappingBySoftValueMapImpl(sessions))
    }

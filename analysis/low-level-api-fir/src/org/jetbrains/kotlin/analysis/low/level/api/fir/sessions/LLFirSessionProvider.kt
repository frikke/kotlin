...
internal class KtModuleToSessionMappingByImmutableMapImpl(
...
internal class KtModuleToSessionMappingBySoftValueMapImpl(
    initialMap: Map<KtModule, LLFirSession>
) : KtModuleToSessionMapping() {
    private val softValuesMap = initialMap.entries.associate { (key, value) -> key to SoftReference(value) }

...
import org.jetbrains.kotlin.gradle.plugin.PropertiesProvider.PropertyNames.KOTLINX_BROWSER_DEFAULT_DEPENDENCY
...
internal class PropertiesProvider private constructor(private val project: Project) {
    ...
    val kotlinxBrowserDefaultDependency: Boolean
        get() = booleanProperty(KOTLINX_BROWSER_DEFAULT_DEPENDENCY) ?: true
    ...
    object PropertyNames {
        ...
        const val KOTLINX_BROWSER_DEFAULT_DEPENDENCY = "kotlinx.browser.default.dependency"
